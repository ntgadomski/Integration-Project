...
/**
 * first term concepts and java code
 * 
...
public class PartOne {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("My name is %s, I was born on %s, " + "so I'm %d years old, and my"
        + " height is %f", myName, DATE_OF_BIRTH, myAge, myHeight); // formating with escape
    // sequences
    ...
    System.out.println(result = (nickMale == false) ? "Nick is indeed a male! (ternary)" // conditional
    // operator
    // '?'
