...
public class PartTwo {
	...
	public static void main(String [] args ){
	    ...
	    firstName = "Joshua";
	    SeparateFile myNameJosh = new SeparateFile(firstName); // calling overloaded constructor
	    ...
	    int len = 12;
	    int high = 13;
	    Rectangle myRect = new Rectangle(len, high); // instantiated a subclass that will use methods from superclass
	    System.out.println(myRect.getArea() + " the subclass Rectangle used getArea() from the superclass Square.");
	     
	    
	}
	    public static int getSmallest(int[] a){  
	        int temp;  
	        for (int i = 0; i < a.length-1; i++)   // selection sort gets smallest by first index
	                {  
